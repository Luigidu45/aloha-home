...
El [modelo portable](/dimos/robot/alohamini2/assets/am_arm200/robot.xml) deriva del URDF suministrado en `/home/luigidu/AlohaMini/AlohaMini2/urdf/alohamini2/urdf/alohamini2.urdf`. Se conservan sus articulaciones, ejes, transformaciones, masas e inercias. Los meshes se simplifican para ejecutar en CPU. La procedencia, hashes, orden de actuadores y supuestos están en el [manifiesto](/dimos/robot/alohamini2/assets/am_arm200/manifest.json) y el [README del modelo](/dimos/robot/alohamini2/assets/am_arm200/README.md).
