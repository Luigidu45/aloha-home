...
9. Siguiente paso, F8: verificar la geometría URDF frente a los STL SO101 existentes, calibrar el montaje, validar interfaces físicas y registrar el primer lote de demostraciones; conservar el protocolo de evaluación antes de ajustar con hardware.
