...
Las dos tareas serán `lectura` y `ordenar_sala`: dos objetos manejables, al menos dos zonas, aproximadamente 10–16 decisiones y oportunidades de recuperación. Esos nombres evitan confundir las misiones M1/M2 del PDF con sus métodos M0–M4. La base se detiene para manipular; no se exige coordinación simultánea de ambos brazos.
