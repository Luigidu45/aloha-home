...
all_blueprints = {
    ...
    "unitree-go2-nav-3d-relocalization-replay": "dimos.robot.unitree.go2.blueprints.navigation.unitree_go2_nav_3d_relocalization_replay:unitree_go2_nav_3d_relocalization_replay",
