...
all_blueprints = {
    ...
    "coordinator-teleop-r1pro": "dimos.robot.galaxea.r1pro.blueprints.manipulation.teleop:coordinator_teleop_r1pro",
    ...
    "r1pro-hosted-teleop-pico": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop:r1pro_hosted_teleop_pico",
    "r1pro-hosted-teleop-quest": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop:r1pro_hosted_teleop_quest",
    ...
    "r1pro-planner-coordinator": "dimos.robot.galaxea.r1pro.blueprints.manipulation.r1pro_planner_coordinator:r1pro_planner_coordinator",
    ...
    "teleop-quest-r1pro": "dimos.teleop.quest.blueprints:teleop_quest_r1pro",
...
all_modules = {
    ...
    "head-camera-decode": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.HeadCameraDecode",
    "headset-arm-teleop-module": "dimos.teleop.quest.quest_extensions.HeadsetArmTeleopModule",
    ...
    "image-decode-module": "dimos.teleop.hosted.image_decode.ImageDecodeModule",
    ...
    "mobile-arm-command-module": "dimos.teleop.hosted.mobile_arm_command.MobileArmCommandModule",
    ...
    "wrist-camera-decode": "dimos.robot.galaxea.r1pro.blueprints.manipulation.hosted_teleop.WristCameraDecode",
