...
from dimos.robot.alohamini1.blueprints.alohamini1_nav_sim import alohamini1_navigation_sim_stack
...
household_navigation_sim = (
    autoconnect(
        alohamini1_navigation_sim_stack(
            scene_xml=ALOHA_MINI1_NAV_MJCF.parent / "household_navigation.xml",
            spawn_xy=(-2.5, -1.0),
        ),
    ...
    .transports(
        {
            ...
            **{
                ...
                for name in ALOHA_MINI1_RGB_CAMERAS
            },
        }
    )
    .global_config(
